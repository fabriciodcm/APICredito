...
namespace APICredito.Tests.Domain
{
    public class LimitePrimeiraParcela
    {
        ...
        public void LimiteInvalidoSuperior()
        {
            ...
            Action validate = () => new PropostaCredito(1000000, "Direto", 24, DateTime.Now.AddDays(41));
        ...
        public void LimiteInvalidoInferior()
        {
            ...
            Action validate = () => new PropostaCredito(1000000, "Consignado", 24, DateTime.Now.AddDays(14));
